			...
			<tr>
				<td colspan="3">
					<a class="btn btn-sm btn-outline-primary" href="<?= base_url(); ?>">
						<span class="fas fw fa-play"> Lanjutkan Booking Buku</span>
					</a>
					<a class="btn btn-sm btn-outline-success" href="<?= base_url().'booking/bookingSelesai/'.$this->session->userdata('id'); ?>">
						<span class="fas fw fa-stop"> Selesaikan Booking Buku</span>
					</a>
				</td>
			</tr>
		</table>
